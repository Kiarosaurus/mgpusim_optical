...
func (b *Builder) createGPUs(
	...
	const numRows = 2                              // Dimension de la topología.
	numCols := (b.numGPUs + numRows - 1) / numRows // Columnas necesarias.
	...
	gpuID := 1
	for f := 0; f < numRows; f++ { // Iterar por filas
		for c := 0; c < numCols; c++ { // Iterar por columnas
